...
const GROUNDS = [
  ...
  { names: ['manuka oval'], city: 'Canberra', state: 'ACT', lat: -35.3186, lng: 149.1349 },
  { names: ['tio stadium', 'marrara oval', 'marrara'], city: 'Darwin', state: 'NT', lat: -12.399, lng: 130.8869 },
  { names: ['utas stadium', 'york park', 'aurora stadium', 'university of tasmania stadium'], city: 'Launceston', state: 'TAS', lat: -41.4261, lng: 147.1387 },
