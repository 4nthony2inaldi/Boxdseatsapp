...
import { isAdmin, fetchIngestStatus } from "@/lib/queries/admin";
...
export default async function AdminIngestPage() {
  ...
  const { jobs, leagues } = await fetchIngestStatus(admin);

  return (
    <div className="max-w-lg mx-auto pb-8">
      <PageHeader title="Admin · Ingest" backHref="/admin" />
      <IngestStatus jobs={jobs} leagues={leagues} />
    </div>
  );
}
